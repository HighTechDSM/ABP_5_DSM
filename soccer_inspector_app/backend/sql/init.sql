...
CREATE DATABASE soccer_stats_hub;
...
-- Tabela de relação usuário-dados
CREATE TABLE users_d_extraidos (
...
CREATE INDEX idx_dados_grupos ON dados_extraidos(grupos);
CREATE INDEX idx_dados_athlete ON dados_extraidos(athlete);
