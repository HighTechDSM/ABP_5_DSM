...
function Login() {
  return (
    <MobileFrame hideNav>
      <div className="flex flex-col h-full px-7 pt-12 pb-6">
        <div className="flex flex-col items-center text-center gap-3">
          <BallLogo size={64} />
          <h1 className="text-2xl font-bold tracking-tight">Bem-vindo de volta</h1>
          <p className="text-sm text-muted-foreground">Entre para acompanhar seu elenco.</p>
        </div>
        ...
        <div className="mt-10 flex flex-col gap-4">
          ...
          <Link to="/app" className="text-xs text-right -mt-1" style={{ color: "var(--primary)" }}>
            Esqueci minha senha
          </Link>
        </div>
        ...
        <div className="mt-8 flex flex-col gap-4">
          ...
          <p className="text-center text-sm text-muted-foreground">
            Novo por aqui?{" "}
            <Link to="/cadastro" style={{ color: "var(--primary)" }} className="font-semibold">
              Criar conta
            </Link>
          </p>
        </div>
